            ...
            <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                ...
                <div class="flex justify-center items-center h-full">
                    <div class="text-center text-white px-6 md:px-12">
                        <h1 class="text-5xl font-bold mt-0 mb-6">Turismo Real</h1>
                        <h3 class="text-3xl font-bold mb-8">Arriendo de departamentos a lo largo del pais.</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
        ...
        <strong>
            <div class="text-center p-6 bg-sky-400">
                ...
                <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Turismo Real</a>
            </div>
        </strong>
